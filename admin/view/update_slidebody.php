...
<form class="modal-content animate" action="controllers.php?act=slidebody_update" method="post" enctype="multipart/form-data">
    

    <div class="container">
      <label ><b>Hình ảnh</b></label>
      <input type="file" name="image" >
      <img style="width: 300px;height:100px;margin-bottom:20px" src="../controller/<?=$cnct[0]['image']?>" alt="Chưa có hình ảnh"><br/>
      <label ><b>Tiêu đề</b></label>
      <input type="text" name="tieude" value="<?=$cnct[0]['tieude']?>">
      <label for=""><b>Mô tả</b ></label>
      <textarea  id="editor" name="mota" id="" rows="10" class="form-control"><?=$cnct[0]['mota']?></textarea>
      <input type=hidden name="id" value="<?=$cnct[0]['id']?>">
      <input type="submit" name="capnhap" value="Cập nhập SlideBody" class="form-control btn btn-danger mt-3">
