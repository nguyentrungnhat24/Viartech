...
<script>
    ...
    <main class="main">
        ...
        <div class="row container">
          ...
          <div class="col">
            <div class="swiper-container slider-2">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="Images/about.jpg" alt="hero image" />
                </div>
                <div class="swiper-slide">
                  <video muted loop autoplay>
                    <source src="./images/Không gian phòng tập The New Gym Vũng Tàu.mp4" type="video/mp4" />
                  </video>
                </div>
                <div class="swiper-slide">
      ...
      <section class="section discount">
        <div class="overlay">
          <video class="video">
            <source src="./images/FITNESS ‐ Được tạo bằng Clipchamp.mp4" type="video/mp4" />
      ...
      <section class="section trip" id="trips">
        ...
        <div class="row container">
          <div class="swiper-container slider-3">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img src="./images/Cởi-trần-tập-gym.jpg" alt="hero image" />
              </div>
              <div class="swiper-slide">
                <img src="./images/chup-anh-phong-gym-14.jpg" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="./images/huong-dan-tap-gym-cho-nam.jpg" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="./images/bai-tap-gym-elle-man-featured-image.jpg" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="./images/imagegym.jpg" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="./images/keotagym.jpg" alt="" />
              </div>
              <div class="swiper-slide">
                <img src="./images/taptaygym.jpg" alt="" />
              </div>
            </div>
          </div>
      ...
      <section class="section more">
        <div class="row container">
          <div class="col">
            ...
            <div class="tours">
              <div class="box">
                <img src="./images/Tạ.jpg" alt="" />
                <h3>Tạ</h3>
              </div>
              <div class="box">
                <img src="./images/Máy.jpg" alt="" />
                <h3>Máy</h3>
      ...
      <section class="section newsletter">
        <div style="margin-top: -90px;" class="row container">
          ...
          <div class="col"><img style="height: 250px;" src="./images/nenphong3.jpg"></div>
        </div>
      </section>
