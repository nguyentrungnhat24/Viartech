...
<form class="modal-content animate" action="controllers.php?act=baiviet_update" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
      ...
      <textarea  id="editor" name="mota" id="" rows="10" class="form-control"><?=$bvct[0]['mota']?></textarea>
      <input type=hidden name="id" value="<?=$bvct[0]['id']?>">
      <input type="submit" name="capnhap" value="Cập nhập bài viết" class="form-control btn btn-danger mt-3">
